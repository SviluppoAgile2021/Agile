...
var addeventatc = function () {
    var e, t, a, n, o, d = !1, c = 1, i = !1, l = !0, r = !1, s = !1, p = !1, u = 1, v = "", m = !0, g = !0, h = !0,
        f = !0, b = !0, w = !0, x = "Apple Calendar", k = "Google <em>(online)</em>", y = "Outlook",
        _ = "Outlook.com <em>(online)</em>", T = "Yahoo <em>(online)</em>", z = "Facebook Event", E = null, N = null,
        C = null, I = null, $ = null, A = null, L = !1;
    return {
        initialize: function () {
            if (!d) {
                d = !0;
            ...
            for (var e = document.getElementsByTagName("*"), t = 0; t < e.length; t += 1) addeventatc.hasclass(e[t], "addeventatc") && function () {
                ...
                e[t].id = a, e[t].title = "", e[t].style.visibility = "visible", e[t].setAttribute("aria-haspopup", "true"), e[t].setAttribute("aria-expanded", "false"), e[t].setAttribute("tabindex", "0"), i ? (e[t].onclick = function () {
                    ...
                    clearTimeout(n), addeventatc.toogle(this, {type: "mouseover", id: a})
                    ...
                    "13" != t && "32" != t && "27" != t && "38" != t && "40" != t || e.preventDefault(), "13" != t && "32" != t || (addeventatc.keyboardclick(this, {
                        ...
                        id: a,
                        key: "up"
                    }), "40" == t && addeventatc.keyboard(this, {type: "keyboard", id: a, key: "down"}), L = !0
                }, e[t].onblur = function () {
                ...
                if ("inline-buttons" == e[t].getAttribute("data-render")) {
                    e[t].onclick = function () {
                    }, addeventatc.toogle(e[t], {
                        type: "render",
                        id: a
                    }), e[t].setAttribute("aria-expanded", "true"), e[t].removeAttribute("tabindex"), e[t].onkeydown = function () {
                    }, e[t].blur = function () {
                    };
            ...
            if (d = $d(o = e.id)) {
                ...
                var r = d.getAttribute("data-intel"), s = d.getAttribute("data-intel-apple");
                if ("ios" == addeventatc.agent() && "click" == n.type && "true" !== s && "false" !== r && (c = "appleical", d.setAttribute("data-intel-apple", "true")), "outlook" == c || "google" == c || "yahoo" == c || "hotmail" == c || "outlookcom" == c || "appleical" == c || "apple" == c || "facebook" == c) "click" == n.type && (addeventatc.click({
                    ...
                    service: c,
                    id: n.id
                }), null != E && addeventatc.trigger("button_click", {id: o})); else if ("mouseover" == n.type && a != d && (p = !1), "click" == n.type || "render" == n.type || "mouseover" == n.type && !p) {
                    "mouseover" == n.type && (p = !0, null != N && addeventatc.trigger("button_mouseover", {id: o})), i = addeventatc.getburl({
                        id: o,
                        facebook: !0
                    ...
                    $d(o + "-appleical") && ($d(o + "-appleical").onclick = function () {
                        addeventatc.click({button: o, service: "appleical", id: n.id})
                    }), $d(o + "-google") && ($d(o + "-google").onclick = function () {
                        addeventatc.click({button: o, service: "google", id: n.id})
                    }), $d(o + "-outlook") && ($d(o + "-outlook").onclick = function () {
                        addeventatc.click({button: o, service: "outlook", id: n.id})
                    }), $d(o + "-outlookcom") && ($d(o + "-outlookcom").onclick = function () {
                        addeventatc.click({button: o, service: "outlookcom", id: n.id})
                    }), $d(o + "-yahoo") && ($d(o + "-yahoo").onclick = function () {
                        addeventatc.click({button: o, service: "yahoo", id: n.id})
                    }), $d(o + "-facebook") && ($d(o + "-facebook").onclick = function () {
                        addeventatc.click({button: o, service: "facebook", id: n.id})
                    }), $d(o + "-home") && ($d(o + "-home").onclick = function () {
                        addeventatc.click({button: o, service: "home", id: n.id})
            ...
            p = !1, addeventatc.hideandreset(), null != C && addeventatc.trigger("button_mouseout", {id: t.id})
        }, show: function (e, t) {
            ...
            if (a && n) if ("block" == addeventatc.getstyle(n, "display")) addeventatc.hideandreset(); else {
                ...
                var l = parseInt(a.offsetHeight), r = parseInt(a.offsetWidth), s = parseInt(n.offsetHeight),
                    p = parseInt(n.offsetWidth), v = addeventatc.viewport(), m = parseInt(v.w), g = parseInt(v.h),
                    h = parseInt(v.x), f = parseInt(v.y), b = addeventatc.elementposition(n), w = parseInt(b.x),
                    x = parseInt(b.y) + s, k = g + f, y = 0, _ = 0;
            ...
            if (a && "block" == addeventatc.getstyle(a, "display")) {
                ...
                for (i = 0; i < n.length; i += 1) if (++d == c) n[i].className += " drop_markup"; else {
                    var l = new RegExp("(\\s|^)drop_markup(\\s|$)");
            ...
            var e = !1, t = window.navigator.userAgent.toLowerCase(), a = /CriOS/i.test(navigator.userAgent),
                n = /instagram/.test(t), o = /iphone|ipod|ipad/.test(t),
