                    ...
                    <div class="register-login-group">
                        <ul>
                            <li>
                                ...
                                <div id="register-modal" class="reglog-modal-wrapper register-modal mfp-hide clearfix"
                                    ...
                                    <div class="overlay-black clearfix">
                                        ...
                                        <div class="leftside-content">
                                            ...
                                            <div class="copyright-text">
                                                <p class="m-0">©2018 <a href="#!" class="yellow-color">Harmoni.com</a>
                        ...
                        <div id="alt-register-modal" class="reglog-modal-wrapper register-modal mfp-hide clearfix"
                            ...
                            <div class="overlay-black clearfix">
                                ...
                                <div class="leftside-content">
                                    ...
                                    <div class="copyright-text">
                                        <p class="m-0">©2018 <a href="#!" class="yellow-color">Harmoni.com</a> all right
                                ...
                                <div class="rightside-content text-center">
                                    ...
                                    <div class="mb-30">
                                        <h2 class="form-title title-large white-color">Account <strong>Register</strong>
                                        </h2>
                                        <span class="form-subtitle white-color">Have an account? <strong>LOGIN NOW</strong></span>
                                    </div>
                        ...
                        <div id="alt-login-modal" class="reglog-modal-wrapper mfp-hide clearfix"
                            ...
                            <div class="overlay-black clearfix">
                                ...
                                <div class="rightside-content text-center">
                                    ...
                                    <div class="mb-30">
                                        <h2 class="form-title title-large white-color">Account <strong>Login</strong>
                                        </h2>
                                        <span class="form-subtitle white-color">Login to our website, or <strong>REGISTER</strong></span>
                                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="breadcrumb-title text-center mb-50">
                            <h2 class="big-title">Elimina Utente<h2>
                        </div>
                ...
                <div class="booking-content-wrapper">
                    ...
                    <div class="billing-info mb-50">
                        ...
                        <div class="section-title mb-30">
                            <h2 class="big-title">Seleziona L'Utente da Eliminare:</h2>
                        </div>
                        <!-- section-title - end -->

                        <!-- billing-form - start -->
                        <div class="billing-form form-wrapper">
                            <form action="../Php/eliminaUtenteController.php" method="post">
                                <label> <strong>Utente:</strong></label>
                                <div class="form-item">
                                    <select class="country-select" name="utente" id="utente" required>
